...
@Component({
  ...
  <a class="navbar-brand" href="#" routerLink = '/products'><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROSGhNugPi-wkkvEePwHNppt8AaZRlUk-y9yEapagLNUaXxy_G" class="logo mr-2"/>Pop that <em>"ish"</em> Shans Snack Kitchen<a class="navbar-brand" href="#" routerLink = '/products'></a>
